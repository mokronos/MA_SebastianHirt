...
for filename in Image/*.ppm; do
    ...
    # Decoding
    ~/ReadersAndCodecs/VVCSoftware_VTM/bin/DecoderAppStatic -b "$fbname"_CTC_"$q".bin -o "$fbname"_CTC_dec_reco_"$q".raw --OutputColourSpaceConvert=GBRtoRGB --OutputBitDepth=8
