...
In \autoref{fig:cer_dist_quality_gt_ezocr}, we observe the $\overline{\text{CER}}_{\text{c}}$ in relation to the true \gls{gt} for different quality levels using EasyOCR.
