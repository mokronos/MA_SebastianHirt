...
\usepackage[ngerman, english]{babel} % can be used for writing the thesis in German
...
\graphicspath{{../images/}{../images/analyze/}{../images/external/}}
...
\begin{document}
    ...
    %\input{texfiles/erklaerung}
    % or
    \input{texfiles/declaration}

    \frontmatter
    \pagenumbering{Roman}
    \tableofcontents
    \input{texfiles/kurzfassung}
    \input{texfiles/abstract}
    \glsresetall % reset all acronyms due to usage in abstract
    ...
    \input{texfiles/qualityassessment}
    \input{texfiles/ocr}
    \input{texfiles/dataset}
    \input{texfiles/evaluation}
