...
class TestMetric(unittest.TestCase):
    ...
    def test_char_error_rate(self):
        ...
        with self.subTest(string1=string1, string2=string2):
            self.assertEqual(helpers.char_error_rate(string1, string2), 0.1)

        string1 = 'test         rs2'
        string2 = 'test rs2'

        with self.subTest(string1=string1, string2=string2):
            self.assertEqual(helpers.char_error_rate(string1, string2), 0.5)
    ...
    def test_nonlinearfitting(self):
        ...
        srocc, plcc, ypre = helpers.nonlinearfitting(objvals, subjvals)
